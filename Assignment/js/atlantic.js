document.addEventListener("DOMContentLoaded", function() {
    ...
    async function fetchOceanInfo() {
        try {
            const response = await fetch("https://en.wikipedia.org/api/rest_v1/page/summary/Atlantic_Ocean");
    ...
    async function fetchImages() {
        try {
            const response = await fetch("https://api.unsplash.com/photos/random?query=atlantic-ocean&count=8&client_id=G2uVaK0UO2CX848ALLi_wcPeikL1paKyy9YV-N9Jvxg");
            const data = await response.json();
            ...
            data.forEach(image => {
                ...
                imgElement.alt = "Atlantic Ocean Image";
    ...
    geoLocationLink.href = "https://en.wikipedia.org/wiki/Atlantic_Ocean";
    ...
    geoLocationImg.src = "https://upload.wikimedia.org/wikipedia/commons/4/47/Atlantic_Ocean_-_en.png";
    geoLocationImg.alt = "Geological Location of the Atlantic Ocean";
