document.addEventListener("DOMContentLoaded", function() {
    ...
    async function fetchOceanInfo() {
        try {
            const response = await fetch("https://en.wikipedia.org/api/rest_v1/page/summary/Arctic_Ocean");
    ...
    async function fetchImages() {
        try {
            const response = await fetch("https://api.unsplash.com/photos/random?query=arctic-ocean&count=8&client_id=G2uVaK0UO2CX848ALLi_wcPeikL1paKyy9YV-N9Jvxg");
            const data = await response.json();
            ...
            data.forEach(image => {
                ...
                imgElement.alt = "Arctic Ocean Image";
    ...
    geoLocationLink.href = "https://en.wikipedia.org/wiki/Arctic_Ocean";
    ...
    geoLocationImg.src = "https://upload.wikimedia.org/wikipedia/commons/5/59/Arctic_Ocean_-_en.png";
    geoLocationImg.alt = "Geological Location of the Arctic Ocean";
