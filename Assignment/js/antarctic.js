document.addEventListener("DOMContentLoaded", function() {
    ...
    async function fetchOceanInfo() {
        try {
            const response = await fetch("https://en.wikipedia.org/api/rest_v1/page/summary/Antarctic_Ocean");
    ...
    async function fetchImages() {
        try {
            const response = await fetch("https://api.unsplash.com/photos/random?query=antarctic-ocean&count=8&client_id=G2uVaK0UO2CX848ALLi_wcPeikL1paKyy9YV-N9Jvxg");
            const data = await response.json();
            ...
            data.forEach(image => {
                ...
                imgElement.alt = "Antarctic Ocean Image";
    ...
    geoLocationLink.href = "https://en.wikipedia.org/wiki/Southern_Ocean";
    ...
    geoLocationImg.src = "https://upload.wikimedia.org/wikipedia/commons/2/28/Location_Southern_Ocean.svg";
    geoLocationImg.alt = "Geological Location of the Antarctic Ocean";
