document.addEventListener("DOMContentLoaded", function() {
    ...
    async function fetchOceanInfo() {
        try {
            const response = await fetch("https://en.wikipedia.org/api/rest_v1/page/summary/Indian_Ocean");
    ...
    async function fetchImages() {
        try {
            const response = await fetch("https://api.unsplash.com/photos/random?query=indian-ocean&count=8&client_id=G2uVaK0UO2CX848ALLi_wcPeikL1paKyy9YV-N9Jvxg");
            const data = await response.json();
            ...
            data.forEach(image => {
                ...
                imgElement.alt = "Indian Ocean Image";
    ...
    geoLocationLink.href = "https://en.wikipedia.org/wiki/Indian_Ocean#";
    ...
    geoLocationImg.src = "https://upload.wikimedia.org/wikipedia/commons/d/d3/Indian_Ocean-CIA_WFB_Map.png";
    geoLocationImg.alt = "Geological Location of the Indian Ocean";
